...
public class ShadowBox {
	...
	protected void update() {
		...
		Vector3f centerNear = Vector3f.add(toNear, camera.getPosition());
		Vector3f centerFar = Vector3f.add(toFar, camera.getPosition());
	...
	private Vector4f[] calculateFrustumVertices(Matrix4f rotation, Vector3f forwardVector, Vector3f centerNear, Vector3f centerFar) {
		...
		Vector3f farTop = Vector3f.add(centerFar, new Vector3f(upVector.x * farHeight, upVector.y * farHeight, upVector.z * farHeight));
		...
		Vector3f nearTop = Vector3f.add(centerNear, new Vector3f(upVector.x * nearHeight, upVector.y * nearHeight, upVector.z * nearHeight));
